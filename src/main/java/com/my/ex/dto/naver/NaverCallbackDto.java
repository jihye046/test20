...
public class NaverCallbackDto {
	...
	public NaverCallbackDto() {}

	public NaverCallbackDto(String callbackCode, String callbackState, String callbackError,
	...
	public String toString() {
		return "NaverCallback [callbackCode=" + callbackCode + ", callbackState=" + callbackState + ", callbackError="
				+ callbackError + ", callbackError_Description=" + callbackError_Description + "]";
	}
}
